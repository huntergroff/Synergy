...
export const ClassDescriptionItems = [
    ...
    },
    {
        ...
        categoryBlurb: "Add a blurb for Lyrical!",
        classes: [
            {
                title: "Lyrical 1",
                age: "4 - 40",
                blurb: "For the brand new lyrical student ..."
            }
        ]
    },
    {
        categoryTitle: "Hip Hop",
        categoryUrlTag: "hip hop",
        categoryImg: (<img src={Pointe} alt="Hip Hop"/>),
        categoryBlurb: "Add a blurb for Hip Hop!",
        classes: [
            {
                title: "Hip Hop 1",
                age: "4 - 50",
                blurb: "For the brand new Hip Hop student ..."
            }
        ]
    }
]